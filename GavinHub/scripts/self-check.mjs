...
assert(wp.includes('createWallpaperThemeController'), 'wallpaper.js should delegate text theme control');
assert(wpTheme.includes('analyzeWallpaperTheme'), 'wallpaper-theme.js should own text theme analysis');
...
assert(bootUi.includes('BOOT_UI_FADE_MS = 720'), 'UI reveal should keep the calm boot timeline');
assert(bootUi.includes('BOOT_VIGNETTE_FADE_MS = 720'), 'vignette reveal should keep the calm boot timeline');
